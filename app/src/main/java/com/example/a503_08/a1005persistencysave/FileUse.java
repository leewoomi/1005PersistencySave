        ...
        switch (v.getId()){
            case R.id.save :
                ...
                try (FileOutputStream fos = openFileOutput("sample.txt",Context.MODE_PRIVATE);)
                {
                    ...
                    fos.flush();
                    editText.setText("파일에 문자열 기록 성공");
            ...
            case R.id.resource :
                ...
                break;
            case R.id.imagecopy :
                try(InputStream fis = getResources().openRawResource(R.raw.phone);
                FileOutputStream fos = openFileOutput("phone.jpg",Context.MODE_PRIVATE);
                ){
